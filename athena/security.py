...
_EARLY_HINTS_BASE = (
    "</static/vendor/app.cb2d3da2.css>; rel=preload; as=style",
    ...
    # it renders every page; the serif faces load on demand on note pages and
    # the italics are too rare to spend preload bytes on.
