...
INSTRUCTIONS = (
    ...
    "manager. 26 tools read; 17 write, in three families. "
    ...
    "and never touches trust accounting, documents, identity verification "
    "or conflict-of-interest checks. A dossier's status is set at CREATION "
