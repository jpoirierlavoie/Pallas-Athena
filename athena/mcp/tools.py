...
TOOLS: dict[str, dict] = {
    ...
    "get_dossier": {
        ...
        "description": (
            ...
            "one), with the full record — including parsed court metadata, "
            "prescription fields, and internal_notes, which are the lawyer's "
            "private notes (treat as sensitive) — plus per-module summaries "
