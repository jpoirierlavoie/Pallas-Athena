...
Source: « Taxonomie des actions en justice — Droit québécois », v1.2
(16 juillet 2026 — a copy sits in ``docs/`` at the repo root), itself aligned
on the FARBQ table « Prescriptions extinctives et autres délais » (avril
2026); ``delai_types``/``avis``/``ref_fondement`` values transcribed from the
binding annexes A/B/C of « SPEC — échéancier par type de délai et avis »
(18 juillet 2026, rév. 2). All are indicative and non-exhaustive. GENERATED
and verified row-by-row; the legal content of this module changes only on an
approved spec — never edit a row by hand, and re-verify against the source.
"""
    ...
    "REC": Domaine(
        ...
        (
            Action("REC-01", "Action sur compte",
                   ...
                   ref_fondement="1590; 1708, 1734; 2098, 2106-2108",
            ...
            Action("REC-06", "Honoraires professionnels",
                   ...
                   ref_delai="Art. 2925, C.c.Q.",
                   ref_fondement="2098, 2106-2108; 2130, 2134",
                   prescription_type="3_ans"),
    ...
    "CON": Domaine(
        ...
        (
            ...
            Action("CON-04", "Nullité",
                   ...
                   ref_delai="2927, 2882",
                   ref_fondement="1398-1408, 1416-1422",
                   prescription_type="3_ans"),
            Action("CON-05", "Réduction de l'obligation / du prix",
                   ...
                   point_depart="Idem",
                   ref_delai="1604 al. 3",
                   ref_fondement="1604 al. 3; 1407-1408",
                   prescription_type="3_ans"),
            ...
            Action("CON-07", "Vices cachés",
                   ...
                   ref_fondement="1726-1731; 38, 53 L.p.c.",
                   avis=(
                       Avis("Dénonciation écrite du vice (délai raisonnable)", None,
                            "découverte du vice", "art. 1739, C.c.Q.",
                            sanction="la dénonciation tardive peut être fatale au recours"),
                   ),
                   prescription_type="3_ans"),
    ...
    "RCV": Domaine(
        ...
        (
            Action("RCV-01", "Préjudice corporel",
                   ...
                   ref_fondement="1457; 1607, 1611 s.",
                   prescription_type="3_ans"),
            ...
            Action("RCV-03", "Préjudice matériel",
                   delai="3 ans",
                   delai_types=("PE",),
                   point_depart="Municipalités — deux régimes : Loi sur les cités et villes : avis 15 jours (A) + action 6 mois (585); Code municipal du Québec : avis 60 jours (A) + action 6 mois (1112.1); fautes ou illégalités : 6 mois (586 LCV)",
                   ref_delai="Art. 2925, C.c.Q.; arts. 585 et 586, Loi sur les cités et villes; art. 1112.1, Code municipal du Québec",
                   ref_fondement="1457",
                   avis=(
                       Avis("Avis à la ville (LCV)", "15_jours",
                            "date de l'accident ou des dommages; inopposable au préjudice corporel (2930 C.c.Q.)", "art. 585, LCV",
                            conditionnel=True),
                       Avis("Avis à la municipalité (CM)", "60_jours",
                            "cause d'action; inopposable au préjudice corporel (2930 C.c.Q.)", "art. 1112.1, CM",
                            conditionnel=True),
                   ),
                   prescription_type="3_ans"),
            Action("RCV-04", "Préjudice moral",
                   ...
                   ref_delai="2926",
                   ref_fondement="1457; 49 Charte qc",
                   prescription_type="3_ans"),
            Action("RCV-05", "Diffamation",
                   delai="1 an; média/journal : 3 mois + avis préalable 3 jours ouvrables",
                   delai_types=("PE", "A"),
                   ...
                   ref_fondement="1457; 3, 35; 4-5, 49 Charte qc",
                   avis=(
                       Avis("Avis préalable au journal", "3_jours_ouvrables",
                            "avant l'action", "art. 3, Loi sur la presse",
                            sanction="condition de la courte prescription de 3 mois", conditionnel=True),
                   )),
            Action("RCV-06", "Vie privée, renseignements personnels",
                   ...
                   ref_fondement="3, 35-41; 5 Charte qc; 1457",
                   prescription_type="3_ans"),
            Action("RCV-07", "Responsabilité professionnelle",
                   ...
                   ref_fondement="1458/1457; 2100; 2138 s.",
                   prescription_type="3_ans"),
            ...
            Action("RCV-11", "Abus de procédure",
                   ...
                   ref_fondement="51-54 C.p.c.; 6-7, 1457",
                   prescription_type="3_ans"),
    ...
    "RES": Domaine(
        ...
        (
            ...
            Action("RES-02", "Enrichissement injustifié",
                   ...
                   ref_delai="1493",
                   ref_fondement="1493-1496",
                   prescription_type="3_ans"),
            Action("RES-03", "Gestion d'affaires",
                   delai="3 ans (art. 2925)",
                   delai_types=("PE",),
                   ref_delai="1482",
                   ref_fondement="1482-1490",
                   prescription_type="3_ans"),
    ...
    "GAG": Domaine(
        ...
        (
            ...
            Action("GAG-02", "Action en inopposabilité (paulienne)",
                   ...
                   ref_delai="Art. 1635, C.c.Q.",
                   ref_fondement="1631-1634",
    ...
    "IMM": Domaine(
        ...
        (
            ...
            Action("IMM-04", "Action du possesseur troublé",
                   ...
                   ref_delai="929",
                   ref_fondement="912, 928-929",
                   prescription_type="1_an"),
            Action("IMM-05", "Empiètement / accession",
                   delai="Variable",
                   delai_types=("V",),
                   ref_delai="992 s.",
                   ref_fondement="954-964; 992"),
            ...
            Action("IMM-08", "Fin d'indivision — partage, licitation",
                   ...
                   delai_types=("I",),
                   ref_delai="1030",
                   ref_fondement="1030, 1032; 836 s.",
                   prescription_type="imprescriptible"),
            Action("IMM-09", "Expropriation (contestation) et expropriation déguisée",
                   delai="Contestation du droit d'exproprier et radiation de l'avis : 30 jours de la date de l'expropriation; expropriation déguisée : atteinte continue",
                   delai_types=("D",),
                   a_valider=True,
                   ...
                   ref_fondement="952; 17 L. expropriation"),
            Action("IMM-10", "Radiation d'inscription (registre foncier)",
                   delai_types=("S",),
                   ref_delai="3057 s.",
                   ref_fondement="3057, 3063"),
    ...
    "CST": Domaine(
        ...
        (
            Action("CST-01", "Perte de l'ouvrage (solidité)",
                   delai="Garantie 5 ans (couverture) + action 3 ans",
                   delai_types=("PE",),
                   point_depart="Fin des travaux; manifestation",
                   ref_delai="2118-2119",
                   ref_fondement="2118 (2119)",
                   prescription_type="3_ans"),
            Action("CST-02", "Malfaçons",
                   delai="Garantie 1 an de la réception + action 3 ans",
                   delai_types=("PE",),
            ...
            Action("CST-03", "Réclamations de chantier (extras, retards)",
                   ...
                   ref_delai="2098 s.",
                   ref_fondement="2098, 2106-2109",
                   avis=(
                       Avis("Avis contractuels de chantier", None,
                            "selon le contrat", "clauses du contrat",
                            sanction="souvent conditions de recevabilité"),
                   ),
                   prescription_type="3_ans"),
            Action("CST-04", "Hypothèque légale de la construction",
                   delai="Inscription : 30 jours de la fin des travaux; action/préavis : 6 mois",
                   delai_types=("D",),
                   point_depart="Fin des travaux",
                   ref_delai="Art. 2727, C.c.Q.",
                   ref_fondement="2724(2°), 2726-2728; 2748 s.",
                   prescription_type="6_mois"),
            Action("CST-05", "Cautionnements de chantier",
                   delai="Délais de la police",
                   delai_types=("A", "V"),
                   a_valider=True,
                   point_depart="Avis à la caution",
                   ref_fondement="2333 s.; 1444 s.",
                   avis=(
                       Avis("Avis à la caution", None,
                            "selon la police", "termes de la police"),
                   )),
    ...
    "COR": Domaine(
        ...
        (
            Action("COR-01", "Oppression / redressement (recours pour abus)",
                   ...
                   ref_fondement="450-453 LSAQ; 241 LCSA",
                   prescription_type="3_ans"),
            Action("COR-02", "Action dérivée (pour le compte de la société)",
                   ...
                   ref_fondement="445-449 LSAQ; 239-240 LCSA"),
            Action("COR-03", "Conventions d'actionnaires (rachat, évaluation)",
                   delai="3 ans",
                   delai_types=("PE",),
                   ref_delai="2925",
                   ref_fondement="1434; 213-214 LSAQ; 146 LCSA",
                   prescription_type="3_ans"),
            Action("COR-04", "Nullité de résolutions; rectification de registres",
                   delai="Diligence",
                   delai_types=("R",),
                   a_valider=True,
                   ref_fondement="450 s., 455 s. LSAQ; 243 LCSA"),
            Action("COR-05", "Liquidation / dissolution judiciaire",
                   delai_types=("N",),
                   ref_delai="463 s. LSAQ",
                   ref_fondement="463 s. LSAQ; 214 LCSA"),
            Action("COR-06", "Responsabilité des administrateurs — salaires impayés",
                   delai="QC : 3 ans, mais poursuite préalable de la société dans 1 an de l'exigibilité; Féd. : durant le mandat ou 2 ans de la cessation, mais poursuite préalable de la société dans 6 mois de l'échéance",
                   delai_types=("PE", "D"),
                   point_depart="Deux conditions préalables distinctes — piège fréquent",
                   ref_delai="154 LSAQ + 2925; 119(2)-(3) LCSA",
                   ref_fondement="154 LSAQ; 119 LCSA"),
            Action("COR-07", "Non-concurrence, non-sollicitation, secrets commerciaux",
                   delai="3 ans + injonction",
                   delai_types=("PE",),
                   ref_delai="2088-2089",
                   ref_fondement="2088-2089, 2095; 1434; 1612",
                   prescription_type="3_ans"),
            Action("COR-08", "Concurrence déloyale",
                   delai="3 ans",
                   delai_types=("PE",),
                   ref_delai="1457; 7 LMC",
                   ref_fondement="1457; 7 LMC",
                   prescription_type="3_ans"),
            Action("COR-09", "Vente d'entreprise (garanties, ajustements de prix)",
                   delai="3 ans ou clause de survie (qualification débattue, 2884)",
                   delai_types=("PE",),
                   a_valider=True,
                   ref_fondement="1434; 1716-1733"),
            Action("COR-10", "Responsabilité des administrateurs — résolutions illicites (émission d'actions, commissions, dividendes, rachats, indemnités)",
                   ...
                   ref_fondement="155-156 LSAQ; 118 LCSA"),
            Action("COR-11", "Dissidence — droit de rachat de l'actionnaire",
                   delai="Confirmation auprès de la société : 30 jours de la réception de l'avis de rachat",
                   delai_types=("D", "A"),
                   a_valider=True,
                   point_depart="Qualification à valider (voir § 4)",
                   ref_delai="380 LSAQ",
                   ref_fondement="372 s. LSAQ; 190 LCSA",
    ...
    "FAI": Domaine(
        ...
        (
            ...
            Action("FAI-07", "Libération d'office du failli / opposition à libération",
                   ...
                   a_valider=True,
                   ref_delai="168.1 LFI",
                   ref_fondement="168.1, 170, 173 LFI"),
    ...
    "FAM": Domaine(
        ...
        (
            ...
            Action("FAM-07", "Filiation",
                   ...
                   ref_fondement="523 s.; 532 s.; 538 s."),
    ...
    "SUC": Domaine(
        ...
        (
            Action("SUC-01", "Vérification de testament (non contentieux)",
                   ...
                   ref_fondement="772-773; 302 s. C.p.c."),
            Action("SUC-02", "Contestation de testament (captation, incapacité)",
                   delai="3 ans, connaissance",
                   delai_types=("PE",),
                   ref_delai="2927",
                   ref_fondement="703-711; 1398 s.",
                   prescription_type="3_ans"),
    ...
    "CJP": Domaine(
        ...
        (
            ...
            Action("CJP-05", "Nullité / invalidité de règlements ou d'actes de l'administration",
                   ...
                   ref_fondement="34, 529 al. 1 (1°) C.p.c."),
            Action("CJP-06", "Déclaration d'inconstitutionnalité / d'inopérabilité",
                   delai_types=("S", "A"),
                   ref_delai="529, 76-78 C.p.c.",
                   ref_fondement="529 al. 1 (1°), 76-78 C.p.c.; 52 LC 1982; 52 Charte qc",
                   avis=(
                       Avis("Avis au procureur général (au plus tard 30 jours avant la mise en état ou l'instruction)", None,
                            "dépôt de l'acte soulevant la question", "arts. 76-78, C.p.c.",
                            sanction="condition de recevabilité de la conclusion"),
                   )),
    ...
    "EXE": Domaine(
        ...
        (
            Action("EXE-01", "Exécution forcée (saisies)",
                   ...
                   ref_fondement="jugement; 656 s. C.p.c."),
            Action("EXE-02", "Opposition à saisie ou à vente",
                   delai="Délais courts d'exécution",
                   delai_types=("V",),
                   ref_delai="735 s. C.p.c.",
                   ref_fondement="735 s. C.p.c."),
            Action("EXE-03", "Outrage au tribunal",
                   delai_types=("N",),
                   ref_delai="57 s. C.p.c.",
                   ref_fondement="57-62 C.p.c."),
            Action("EXE-04", "Pourvoi en rétractation de jugement",
                   delai="Deux étapes de rigueur : signification 30 jours (disparition de l'empêchement / connaissance du jugement, de la preuve ou du fait), puis présentation 30 jours de la signification; plafond : 6 mois du jugement",
                   delai_types=("D",),
                   ref_delai="347 C.p.c.",
                   ref_fondement="345-346 C.p.c."),
    ...
    "TRN": Domaine(
        ...
        (
            Action("TRN-01", "Transporteur interne de biens",
                   delai="Avis : 60 jours de la délivrance (bien délivré) ou 9 mois de l'expédition (bien non délivré), sous peine d'irrecevabilité; action : 3 ans",
                   delai_types=("PE", "A"),
                   point_depart="Délivrance ou date à laquelle le bien aurait dû être délivré",
                   ref_delai="Arts. 2050 et 2925, C.c.Q.",
                   ref_fondement="2030 s.; 2049-2053",
                   avis=(
                       Avis("Avis écrit au transporteur (bien délivré)", "60_jours",
                            "délivrance du bien", "art. 2050 al. 2, C.c.Q.",
                            sanction="sous peine d'irrecevabilité (sauf action intentée dans le délai)", conditionnel=True),
                       Avis("Avis écrit au transporteur (bien non délivré)", "9_mois",
                            "expédition du bien", "art. 2050 al. 2, C.c.Q.",
                            sanction="sous peine d'irrecevabilité (sauf action intentée dans le délai)", conditionnel=True),
                   ),
                   prescription_type="3_ans"),
            ...
            Action("TRN-03", "Passagers et bagages — maritime",
                   ...
                   ref_fondement="37 LRMM; ann. 2, art. 3",
            ...
            Action("TRN-07", "Droit maritime canadien — recours résiduel",
                   ...
                   ref_delai="140 LRMM",
                   ref_fondement="22 LCF; droit maritime canadien",
                   prescription_type="3_ans"),
    ...
    "ADM": Domaine(
        ...
        (
            Action("ADM-01", "TAQ — recours principal",
                   ...
                   ref_fondement="loi sectorielle; 14 LJA"),
            ...
            Action("ADM-07", "Fiscalité municipale — rôle d'évaluation",
                   ...
                   ref_fondement="124 s., 138.5, 171-174 LFM"),
            ...
            Action("ADM-10", "IVAC — demande de qualification",
                   ...
                   ref_fondement="8 s., 25 Loi P-9.2.1"),
    ...
    "TRV": Domaine(
        ...
        (
            ...
            Action("TRV-02", "Pratiques interdites",
                   ...
                   ref_fondement="122, 122.1, 123 LNT"),
            Action("TRV-03", "Harcèlement psychologique",
                   ...
                   ref_fondement="81.18-81.20, 123.6 s. LNT",
                   prescription_type="2_ans"),
            Action("TRV-04", "Réclamation civile sous la LNT",
                   ...
                   point_depart="Chaque échéance",
                   ref_delai="115 LNT",
                   ref_fondement="40 s., 98-99, 113 LNT",
                   prescription_type="1_an"),
            Action("TRV-05", "Code du travail — plaintes et rapports collectifs",
                   ...
                   ref_fondement="12-15, 47.2, 100 s. CT"),
            Action("TRV-06", "LATMP — volet travailleur",
                   ...
                   ref_fondement="32, 44 s., 267 s. LATMP"),
            ...
            Action("TRV-08", "Code canadien du travail (entreprises fédérales)",
                   ...
                   ref_fondement="97, 133, 147, 240 CCT",
                   prescription_type="90_jours"),
    ...
    "APP": Domaine(
        ...
        (
            ...
            Action("APP-04", "Appels statutaires — Cour du Québec",
                   ...
                   ref_fondement="91 LTAL; 147 LAI; 61 LPRP; 159 LJA"),
            ...
            Action("APP-07", "Pénal / réglementaire (C.p.p.)",
                   ...
                   ref_fondement="266 s., 291 s. C.p.p."),
...
# Relief mechanisms for the déchéances relevables (Annexe A « Notes DR » of
# the spec). DR actions absent from this dict get the engine's generic
# « mécanisme de relief prévu par la loi habilitante » note.
DR_RELIEF_NOTES: dict[str, str] = {
    "ADM-01": "relief : art. 106, LJA",
    "ADM-04": "relief : art. 93.1.13, LAF",
    "ADM-05": "relief : art. 166.1, LIR",
    "ADM-06": "relief : art. 167, LIR",
    "ADM-09": "relief : art. 11 al. 2, LAA",
    "ADM-10": "relief : art. 25 al. 2, Loi P-9.2.1",
    "TRV-06": "relief : art. 352, LATMP",
    "TRV-08": "relief : art. 240(3), CCT",
    "TRN-04": "relief : art. 23(2), LRMM",
    "APP-02": "prorogation propre au régime",
    "APP-03": "prorogation propre au régime",
    "APP-05": "prorogation propre au régime",
    "APP-06": "prorogation propre au régime",
    "APP-07": "prorogation propre au régime",
}
