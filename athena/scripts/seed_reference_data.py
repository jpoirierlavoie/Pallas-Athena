...
JURIDICTIONS = [
    ...
    ("04", "Cour supérieure", "Chambre familiale", "GC"),
    ...
    ("09", "Cour d'appel", "Chambre civile", "GC"),
    ("10", "Cour d'appel", "Chambre criminelle et pénale", "GC"),
    ("11", "Cour supérieure", "Chambre commerciale", "GC"),
    ("12", "Cour supérieure", "Chambre familiale", "GC"),
    ("13", "Cour supérieure", "Chambre familiale", "GC"),
    ("14", "Cour supérieure", "Procédures non contentieuses", "GC"),
    ("17", "Cour supérieure", "Chambre civile", "GC"),
    ("18", "Cour supérieure", "Shérif", "GC"),
    ("19", "Cour du Québec", "Chambre civile", "GC"),
    ("22", "Cour du Québec", "Chambre civile", "GC"),
    ("32", "Cour du Québec", "Division des petites créances", "GC"),
    ("34", "Cour du Québec", "Chambre civile", "GC"),
    ("36", "Cour supérieure", "Procès de novo", "GC"),
    ("38", "Cour du Québec", "Chambre criminelle et pénale", "GC"),
    ("46", "\u2014", "Appels divers", "GC"),
    ("53", "Cour du Québec", "Tribunal des droits de la personne", "GC"),
    ("80", "Cour du Québec", "Appel en matière administrative", "GC"),
    ("01", "Cour supérieure", "Chambre criminelle", "GP"),
    ("27", "Cour du Québec", "Chambre criminelle et pénale", "GP"),
    ("72", "\u2014", "Infractions statutaires fédérales", "GP"),
    ("73", "\u2014", "Dossiers G.R.C.", "GP"),
    ("61", "Cour du Québec", "Chambre criminelle et pénale", "GI"),
]
