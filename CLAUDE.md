...
| `/dossiers/<id>/tab/<tab_name>` | GET | HTMX tab loader. Leaf slugs: `apercu` (empty), `temps` — default, `facturation`, `fideicommis`, `audiences` (« Calendrier »), `taches`, `protocole`, `documents`; legacy `agenda` maps to `audiences` |
